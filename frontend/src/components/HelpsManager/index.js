          ...
          <Grid spacing={2} justifyContent='flex-end' container>
            ...
            <Grid sm={3} md={1} item>
              <ButtonWithSpinner
                ...
                variant='contained'
              >
                {i18n.t('helpsManager.buttons.clear')}
              </ButtonWithSpinner>
            </Grid>
            {record.id !== undefined ? (
              <Grid sm={3} md={1} item>
                <ButtonWithSpinner
                  ...
                  color='secondary'
                >
                  {i18n.t('helpsManager.buttons.delete')}
                </ButtonWithSpinner>
              </Grid>
            ) : null}
            <Grid sm={3} md={1} item>
        ...
        <TableHead>
          <TableRow>
            ...
            <TableCell align='left'>
              {i18n.t('helpsManager.table.title')}
            </TableCell>
            <TableCell align='left'>
              {i18n.t('helpsManager.table.description')}
            </TableCell>
            <TableCell align='left'>
              {i18n.t('helpsManager.table.video')}
            </TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
...
export default function HelpsManager() {
  ...
  return (
    <Paper className={classes.mainPaper} elevation={0}>
      ...
      <ConfirmationModal
        title={i18n.t('helpsManager.confirmationModal.title')}
        open={showConfirmDialog}
        onClose={() => setShowConfirmDialog(false)}
        onConfirm={() => handleDelete()}
      >
        {i18n.t('helpsManager.confirmationModal.message')}
      </ConfirmationModal>
    </Paper>
  );
}
