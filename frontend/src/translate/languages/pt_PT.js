  ...
  pt_PT: {
    translations: {
      ...
      settings: {
        ...
        FileUploadLimit: {
          title: 'Limite de Upload de ficheiros (MB)',
        },
        FileDownloadLimit: {
        ...
        ticketAcceptedMessage: {
          title: 'Mensagem de ticket aceite',
          placeholder: 'Digite a sua mensagem de ticket aceite aqui',
        },
        transferMessage: {
          title: 'Mensagem de transferência',
          placeholder: 'Digite a sua mensagem de transferência aqui',
        },
        mustacheVariables: {
        ...
        officeHours: 'Horário de expediente',
        officeManagement: 'Gestão de Expediente',
        managementByQueue: 'Gestão Por Fila',
        managementByCompany: 'Gestão Por Empresa',
        groups: 'Grupos',
        ...
        respectMessageQueue: 'Respeitar fila da mensagem',
        respectTicketQueue: 'Respeitar fila do ticket',
        keepQueueAndUser: 'Manter fila e utilizador',
        api: 'API',
