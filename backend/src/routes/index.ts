...
import leadAssignmentRoutes from "./leadAssignment";
import leadColumnRoutes from "./leadColumnRoutes";
import leadRoutes from "./leadRoutes";
import leadTagRoutes from "./leadTagRoutes";
...
import quoteTemplateRoutes from "./quoteTemplateRoutes";
...
routes.use(leadTagRoutes);
routes.use(pwaRoutes);
routes.use(versionRoutes);
routes.use(leadColumnRoutes);
routes.use(quoteRoutes);
routes.use(quoteTemplateRoutes);
routes.use(interactionRoutes);
routes.use("/api", leadAssignmentRoutes);
